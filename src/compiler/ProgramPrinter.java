...
//        }
    ...
    public void enterSelectionStatement(CParser.SelectionStatementContext ctx) {
        String str = ctx.statement(0).compoundStatement().blockItemList().blockItem(0)
                .statement().getText();
        if(nested >= 0){
...
//        for(int i = 0; i < ctx.statement(0).compoundStatement().blockItemList().blockItem().size(); i++){
//
//            if(str.substring(0,2).equals("if") || str.substring(0,3).equals("for")){
//
//            }
//        }
        nested++;
...
//        for(int i = 0; i < ctx.statement().compoundStatement().blockItemList().blockItem().size(); i++){
//            if(nested >= 0){
//                for(int j = 0; j < indet; j++){
//                    System.out.print("    ");
//                }
